...
STORIES = [
    {
        "title": "等到熟成才採",
        "subtitle": "多等一次花期，換一瓶不用調的蜜",
        "sort_order": 1,
        "content": "蜂蜜可以提早採。蜜蜂剛把花蜜搬回巢裡、還沒煉乾的時候採下來，重量最好看，但水分高、容易發酵，得再用機器抽水或加東西調整。\n\n我們選擇等。等蜜蜂自己把水分煉到夠低、在巢房上封起蠟蓋，那才是熟成的蜜。多等的這段時間會少採一些，但採下來就是可以直接裝瓶的狀態，不用加水、不用加糖、不用調味。\n\n低溫時會結晶，那是天然蜂蜜的正常現象，隔水溫熱就會恢復。（這段文字可於後台「故事管理」自行修改）",
    },
    {
        "title": "基隆的雨，基隆的花",
...
SETTINGS = {
    ...
    "hero_desc": "蜂場就在基隆七堵的山上。我們等蜜在巢裡封蓋、熟成了才採，"
                 "裝瓶前不加水、不加糖。每一瓶都查得到生產者是誰 —— "
                 "農業部的溯源編號就印在上面。",
    "producer_name": "黃皇龍",
