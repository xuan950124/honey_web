...
def test_real_and_messy_addresses():
    print("\n[實際會遇到的寫法]")
    cases = [
        ("基隆市七堵區實踐路1號", "206", "建單失敗的那種地址"),
        ("206基隆市七堵區實踐路1號", "206", "客人自己填了郵遞區號"),
        ("20648基隆市七堵區實踐路1號", "206", "5 碼只取前 3 碼"),
        ("七堵區實踐路1號", "206", "沒寫縣市，但七堵全台唯一"),
        ("台北市信義區市府路45號", "110", "用『台』不用『臺』"),
        ("　基隆市 七堵區 實踐路1號　", "206", "有多餘空白"),
        ("基隆市七堵區實踐路１號", "206", "全形數字"),
        ("新北市新莊區中正路100號", "242", ""),
        ("桃園市中壢區中大路300號", "320", ""),
